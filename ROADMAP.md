...
- ✅ **Flight Modes** - Pressing "B" toggles between COMBAT And NAVIGATION flight modes. Combat reduces speed with max power to weapons and shields. Navigation disables weapons and reduces shields for much greater thrust power for faster space travel.
